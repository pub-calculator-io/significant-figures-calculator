...
Version: 1.0.0
Author: Significant Figures Calculator / www.calculator.io
...
function display_calcio_ci_significant_figures_calculator(){
    $page = 'index.html';
...
add_shortcode( 'ci_significant_figures_calculator', 'display_calcio_ci_significant_figures_calculator' );